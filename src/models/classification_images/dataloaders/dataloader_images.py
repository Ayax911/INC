...
if __name__ == "__main__":
    ...
    inputs          = "/media/imagenesmedicas/DATA1/01-ImagenesMedicas-US1/05-INC/02-DataExperiments/02-Mammo-s224-i11_v1"
    
    # Create an instance of the Loader class
    loader = Loader(inputs,True)
